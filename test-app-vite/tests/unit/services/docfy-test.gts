...
module('Unit | Service | @docfy/docfy', function (hooks) {
  ...
  test('it finds nested children by path with slashes', function (assert) {
    ...
    const emberComponents = service.findNestedChildrenByName(
      'docs/ember/components'
    );
    if (emberComponents) {
  ...
  test('it returns current page based on router URL', function (assert) {
    ...
    const stub = sinon
      ...
      .get(() => '/docs/ember/components/docfy-previous-and-next-page');
  ...
  test('it finds previous and next pages', function (assert) {
    ...
    assert.ok(
      ...
      'Previous page should be a PageMetadata or undefined'
    );
    assert.ok(
      nextPage || nextPage === undefined,
      'Next page should be a PageMetadata or undefined'
    );
  ...
  test('it finds previous and next pages with scope', function (assert) {
    ...
    assert.ok(
      previousPage || previousPage === undefined,
      'Previous page with scope should be a PageMetadata or undefined'
    );
    assert.ok(
      nextPage || nextPage === undefined,
      'Next page with scope should be a PageMetadata or undefined'
    );
