...
<template>
  ...
  <div class="px-4 py-12 overflow-hidden bg-gray-900 md:text-center md:pt-32 md:pb-40 angled">
    <div class="relative max-w-256 md:mx-auto">
      <div class="absolute w-56 h-56 -bottom-32 -right-24 md:h-full bg-dot-lg md:-top-8 md:-left-8"></div>
  ...
  <div class="px-4 py-16 overflow-hidden bg-gray-700 md:pb-24 md:pt-48 md:-mt-32">
    <div class="relative z-0 mx-auto max-w-screen-lg">
      <div class="relative z-10 bg-gray-700">
        ...
        <p class="pb-16 text-xl font-semibold leading-snug text-gray-400 md:text-center max-w-200 md:mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-16">
          ...
          >
            ...
            <a class="underline" href="https://remark.js.org/" target="_blank" rel="noopener noreferrer">remark</a>.
            You can extend and modify the output by using their vast selection of plugins.
          </FeatureCard>
          <FeatureCard
            @title="Multi-location source files"
          >
          ...
          <FeatureCard
            @title="Demos"
          >
            We combine "demo" markdown files into a data structure representing a page; You can turn these demos into executable code.
            <DocfyLink @to="/docs/writing-markdown" @anchor="demos" class="underline">
              Learn more here.
            </DocfyLink>
          </FeatureCard>
          <FeatureCard
          ...
          <FeatureCard
            @title="Correct links between files"
          >
          ...
          <FeatureCard
            @title="Table of Content per page"
          >
  ...
  <div class="px-4 py-16 overflow-hidden bg-gray-900 md:py-24">
    <div class="relative mx-auto max-w-screen-lg">
      ...
      <div class="absolute w-2/3 h-20 mt-2 -right-32 -bottom-24 bg-dot-lg"></div>
    </div>
  </div>
  ...
  <div class="px-4 py-16 overflow-hidden bg-gray-800 md:py-24">
    <div class="relative mx-auto max-w-screen-lg">
      <h3 class="mb-8 font-semibold leading-snug md:mx-auto max-w-256 md:pr-48">
        ...
        <span class="block text-xl text-green-500 md:text-2xl">Start building your next docs site with Ember and Docfy.</span>
      </h3>

      <DocfyLink @to="/docs/ember"
      ...
      <div class="absolute top-0 hidden md:block right-10">
        <div class="w-20 h-20 bg-dot-brighter-lg"></div>
        <div
          class="w-20 h-20 mt-2 ml-20 bg-dot-brighter-lg"
        >
        </div>
      </div>
      <div class="absolute left-0 w-2/3 h-20 mt-2 ml-1 -bottom-24 bg-dot-lg"></div>
    </div>
  </div>
</template>