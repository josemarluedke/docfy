...
<template>
  ...
  >
    <div class="relative max-w-256 md:mx-auto">
      ...
      <div class="absolute -top-16 right-6 md:-right-2 md:-top-16">
        ...
        <div class="absolute w-20 h-20 bg-dot-brighter-lg top-14 left-14">
        </div>
      </div>
      ...
      <h2 class="mb-10 text-4xl md:mb-16 md:mx-auto md:text-5xl max-w-256">
        ...
        <span class="text-green-500">
          Write Markdown, get interactive demos.
        </span>
      </h2>
      <p class="text-gray-400 max-w-200 md:mx-auto">
        Stop maintaining docs separately from code. Docfy transforms your
        Markdown files into rich, interactive documentation with live component
        demos — all from your existing development workflow.
      </p>

      <DocfyLink
        @to="/docs/ember/tutorial"
    ...
    <div class="relative z-0 mx-auto max-w-screen-lg">
      <div class="relative z-10 bg-gray-700">
        <h3 class="pb-6 text-3xl font-semibold text-gray-200 md:text-center">
          <span class="sr-only">Ember.js Integration</span>
          <svg
            class="mx-auto"
            width="238"
            height="114"
        ...
        <p
          class="pb-16 text-xl font-semibold leading-snug text-gray-300 md:text-center max-w-200 md:mx-auto"
        >
          Turn your Ember app into a documentation powerhouse. Perfect for
          component libraries, design systems, and addon documentation with live
          component previews.
        </p>
        ...
        >
          <FeatureCard @title="Component Playground" @icon="#E04E39">
            Document your components with live examples. Write GJS/GTS,
            JavaScript, and CSS in Markdown — Docfy turns them into interactive
            demos with full TypeScript support.
          </FeatureCard>
          <FeatureCard @title="Instant previews" @icon="#E04E39">
            Add `preview-template` to any GJS code block and see it rendered
            live alongside the source code. Modern Ember syntax supported.
          </FeatureCard>
          <FeatureCard @title="Rich navigation components" @icon="#E04E39">
            Drop-in components for sidebars, breadcrumbs, "on this page"
            sections, and previous/next navigation. No custom code needed.
          </FeatureCard>
          <FeatureCard @title="GJS/GTS in Markdown" @icon="#E04E39">
            Write modern Ember components with GJS/GTS syntax directly in
            Markdown. Full TypeScript support and co-located templates.
          </FeatureCard>
          <FeatureCard @title="FastBoot ready" @icon="#E04E39">
            Full server-side rendering support. Generate static sites with
            Prember or serve dynamic content with FastBoot.
          </FeatureCard>
          <FeatureCard @title="Static site generation" @icon="#E04E39">
            Deploy anywhere with Prember integration. Docfy automatically
            discovers all documentation URLs for static pre-rendering.
          </FeatureCard>
        </div>
      </div>
  ...
  <div class="px-4 py-16 overflow-hidden bg-blue-900 md:pb-24 md:pt-28">
    <div class="relative z-0 mx-auto max-w-screen-lg">
      <div class="relative z-10 bg-blue-900">
        <div
        ...
        <h3 class="pb-6 text-3xl font-semibold text-blue-100 md:text-center">
          <svg
            class="inline-block w-6 h-6 mr-2 fill-current text-blue-300"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M13 1L1 14h6l-2 9 12-13h-6l2-9z" />
          </svg>
          Powered by Vite
        </h3>
        <p
        ...
        >
          ...
          lightning-fast development with modern tooling and instant live
          reload.
        </p>
        ...
        >
          <FeatureCard @title="Lightning Fast Live Reload" @icon="#646CFF">
            Changes to your markdown files are instantly reflected in the
            browser with automatic page refresh.
          </FeatureCard>
          <FeatureCard @title="ESM-Native Development" @icon="#646CFF">
            No bundling during development means faster startup times and
          ...
          <FeatureCard @title="Flexible Configuration" @icon="#646CFF">
            Configure Docfy through vite.config.js or dedicated config files
  ...
  <div class="px-4 py-16 overflow-hidden bg-gray-700 md:pb-24 md:pt-28">
    <div class="relative z-0 mx-auto max-w-screen-lg">
      <div class="relative z-10 bg-gray-700">
        <h3 class="pb-6 text-3xl font-semibold text-gray-200 md:text-center">
        ...
        >
          Built on a modular core that could power documentation for any
          framework. Today's focus: making Ember documentation exceptional.
        </p>

        <div
          class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-16"
        >
          <FeatureCard @title="Git-native workflow">
            Write docs in Markdown alongside your code. Use pull requests for
            docs reviews, version control for history, and branches for feature
            documentation.
          </FeatureCard>
          <FeatureCard @title="Monorepo-friendly">
            Perfect for component libraries and design systems. Collect docs
            from multiple packages automatically and organize them into a
            unified documentation site.
          </FeatureCard>
          <FeatureCard @title="Live component demos">
            Write component examples in Markdown and see them rendered live. No
            separate playground setup — your docs become interactive examples
            that always stay in sync.
            <DocfyLink @to="/docs/ember/writing-demos" class="underline">
              See how it works.
            </DocfyLink>
          </FeatureCard>
          <FeatureCard @title="Extensible with plugins">
            Built on
            <a
              class="underline"
            ...
            >remark</a>
            with access to 150+ plugins. Add syntax highlighting, math
            equations, diagrams, or custom processing.
          </FeatureCard>
          <FeatureCard @title="Smart link resolution">
            Link between docs using file paths. Docfy automatically converts
            them to correct URLs, so links never break when you reorganize your
            documentation.
          </FeatureCard>
          <FeatureCard @title="Auto-generated navigation">
            Automatic table of contents, previous/next links, and sidebar
            navigation. Focus on writing content, not maintaining navigation.
          </FeatureCard>
        </div>
      </div>
      <div class="absolute z-0 w-full h-full top-32 bg-dot-lg -right-32"></div>
  ...
  <div class="px-4 py-16 overflow-hidden bg-gray-800 md:py-24">
    <div class="relative mx-auto max-w-screen-lg">
      ...
      <p
        class="pb-16 text-xl font-semibold leading-snug text-gray-400 md:text-center max-w-200 md:mx-auto"
      >
        From component libraries to API docs, Docfy adapts to your workflow.
      </p>
      ...
      >
        <div class="text-center">
          <div
            class="w-16 h-16 mx-auto mb-4 bg-green-500 rounded-lg flex items-center justify-center"
          >
            <svg
            ...
            >
              <path
                d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.66 0 3-1.34 3-3 0-.78-.29-1.48-.78-2.01-.17-.18-.22-.47-.12-.7.08-.2.27-.29.48-.29H18c2.76 0 5-2.24 5-5 0-5.52-4.48-10-11-10zm-5.5 9c-.83 0-1.5-.67-1.5-1.5S5.67 8 6.5 8 8 8.67 8 9.5 7.33 11 6.5 11zm3-4C8.67 7 8 6.33 8 5.5S8.67 4 9.5 4s1.5.67 1.5 1.5S10.33 7 9.5 7zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 4 14.5 4 16 4.67 16 5.5 15.33 7 14.5 7zm3 4c-.83 0-1.5-.67-1.5-1.5S16.67 8 17.5 8s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"
              />
            </svg>
          </div>
          <h4 class="text-lg font-semibold text-white mb-2">Design Systems</h4>
          <p class="text-gray-400 text-sm">
            Document components with live examples, guidelines, and design
            tokens.
          </p>
        </div>
        ...
        <div class="text-center">
          <div
            class="w-16 h-16 mx-auto mb-4 bg-blue-500 rounded-lg flex items-center justify-center"
          >
            <svg
              class="w-8 h-8 fill-current text-white"
              viewBox="0 0 24 24"
          ...
          <h4 class="text-lg font-semibold text-white mb-2">Component Libraries</h4>
          <p class="text-gray-400 text-sm">
            Show off your components with interactive demos and API
            documentation.
          </p>
        </div>
        ...
        <div class="text-center">
          <div
            class="w-16 h-16 mx-auto mb-4 bg-purple-500 rounded-lg flex items-center justify-center"
          >
            <svg
              class="w-8 h-8 fill-current text-white"
              viewBox="0 0 24 24"
          ...
          <h4 class="text-lg font-semibold text-white mb-2">Ember Addons</h4>
          <p class="text-gray-400 text-sm">
            Document your addon's API, components, and usage examples.
          </p>
        </div>

        <div class="text-center">
          <div
            class="w-16 h-16 mx-auto mb-4 bg-orange-500 rounded-lg flex items-center justify-center"
          >
            <svg
              class="w-8 h-8 fill-current text-white"
              viewBox="0 0 24 24"
          ...
          <h4 class="text-lg font-semibold text-white mb-2">Engineering Docs</h4>
          <p class="text-gray-400 text-sm">
            Architecture guides, API references, and team documentation.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="relative mx-auto max-w-screen-lg">
      <h3 class="mb-8 font-semibold leading-snug md:mx-auto max-w-256 md:pr-48">
        ...
        <span class="block text-xl text-green-500 md:text-2xl">Start building
          documentation that developers actually want to maintain.</span>
      </h3>
