...
them to deliver well-crafted documentation sites is the reason Docfy exists.</p>
<p>There are a lot of amazing tools out there for writing documentation sites; however,
most of them are specific to a framework without exposing any core functionality
for writing documentation sites for other frameworks or libraries.</p>
<p>A common use case for documentation sites is for demoing a component library or a
