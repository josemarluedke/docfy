...
<tabs.Tab @label="pnpm">
<DocfyCodeBlock @language="sh"><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e" tabindex="0" data-language="sh"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">pnpm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF"> add</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF"> @docfy/plugin-shiki</span></span></code></pre></DocfyCodeBlock>
</tabs.Tab>
<tabs.Tab @label="npm">
...
<tabs.Tab @label="yarn">
<DocfyCodeBlock @language="sh"><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e" tabindex="0" data-language="sh"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">yarn</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF"> add</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF"> @docfy/plugin-shiki</span></span></code></pre></DocfyCodeBlock>
</tabs.Tab>
<tabs.Tab @label="bun">
<DocfyCodeBlock @language="sh"><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e" tabindex="0" data-language="sh"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">bun</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF"> add</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF"> @docfy/plugin-shiki</span></span></code></pre></DocfyCodeBlock>
</tabs.Tab>
</DocfyCodeTabs>
...
<DocfyCodeBlock @language="ts" @title="app/services/session.ts" @showLineNumbers={{true}}><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e" tabindex="0" data-language="ts"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8"> Service, { service } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF"> '@ember/service'</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">;</span></span>
...
<span class="line highlighted" data-highlighted=""><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">  @service </span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70">router</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">;</span></span>
<span class="line"></span>
...
<span class="line highlighted" data-highlighted=""><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">      body: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF">JSON</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">stringify</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">({ email, password }),</span></span>
<span class="line highlighted" data-highlighted=""><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">    });</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF">    this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">.router.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">transitionTo</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">'dashboard'</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">);</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">  }</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF">    this</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">.router.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0">transitionTo</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF">'login'</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">);</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">}</span></span></code></pre></DocfyCodeBlock>
<p>Line 4 highlights the <code>router</code> service injection this snippet uses to
redirect after authenticating; lines 9-12 highlight the <code>fetch</code> call itself,
start to finish.</p>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8">:::</span></span></code></pre></DocfyCodeBlock>
<p>Every other fence feature still applies inside a tab, with one exception:
inside a <code>:::code-tabs</code> group, a fence's <code>title="..."</code> sets the <strong>tab's
label</strong> rather than a separate title bar on the block — that's what names
each of the "pnpm" / "npm" tabs above. A tabbed fence can still be
<code>collapsible</code>, highlight a line range, and so on.</p>
