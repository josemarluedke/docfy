...
<pre><code class="hljs language-js"><span class="hljs-keyword">import</span> { getDocfyOutput } <span class="hljs-keyword">from</span> <span class="hljs-string">'@docfy/virtual/output'</span>;
